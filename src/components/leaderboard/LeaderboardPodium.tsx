...
const PLACES: PlaceConfig[] = [
  {
    ...
    avatarHome: "h-20 w-20 md:h-28 md:w-28",
  },
  {
    place: 1,
    label: "Nhất",
    ...
    avatarHome: "h-24 w-24 md:h-32 md:w-32",
  },
  {
    place: 3,
    label: "Ba",
  ...
  return (
    <section
      className={`relative overflow-hidden rounded-3xl border border-outline-variant bg-gradient-to-b from-primary-fixed via-surface-container-lowest to-surface-container-low pb-0 ${
        isHome
          ? "mb-6 px-6 pt-10 md:px-12 md:pt-12"
          ...
          return (
            ...
            >
              ...
              >
                <div className="relative mb-2">
                  ...
                  <span
                    className={`absolute -right-1 -bottom-1 flex items-center justify-center rounded-full font-extrabold shadow ${cfg.badgeClass} ${
                      isHome ? "h-8 w-8 text-sm" : "h-7 w-7 text-xs"
                    }`}
                  >
                    {cfg.place}
                  </span>
                ...
                <MaterialIcon
                  className={`mb-1 ${
                    isFirst
                      ...
                      : isHome
                        ? "text-3xl text-[#173A67] md:text-4xl"
                ...
                <p
                  className={`max-w-[9rem] text-center font-extrabold text-on-surface md:max-w-[13rem] ${
                    isFirst
                      ? isHome
                        ? "text-lg md:text-xl"
                ...
                {!maskIdentity && entry.department ? (
                  <p className="mt-0.5 max-w-[9rem] truncate text-center text-[11px] text-on-surface-variant md:max-w-[13rem] md:text-xs">
                    {entry.department}
                  </p>
                ) : null}
                <p
